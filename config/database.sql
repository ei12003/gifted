...
insert into Itens (part,name, img_location, description, price) values (1,'Blue T-shirt', 'https://feupload.fe.up.pt/get/rY9GKR1J1OBazNp', 'odio curabitur convallis duis consequat dui nec nisi volutpat eleifend donec ut dolor morbi vel lectus in', 94);
insert into Itens (part,name, img_location, description, price) values (1,'White T-shirt', 'https://feupload.fe.up.pt/get/vu5Ju7tE791oBFQ', 'faucibus orci luctus et ultrices posuere cubilia curae duis faucibus accumsan odio', 50);
insert into Itens (part,name, img_location, description, price) values (2,'Black eyes', 'https://feupload.fe.up.pt/get/VKS8mwfba1JOTPy', 'id luctus nec molestie sed justo pellentesque viverra pede ac diam cras pellentesque volutpat dui maecenas tristique', 85);
insert into Itens (part,name, img_location, description, price) values (2,'Red eyes', 'https://feupload.fe.up.pt/get/qr08OmsrYn8KJcA', 'platea dictumst aliquam augue quam sollicitudin vitae consectetuer eget rutrum', 76);
insert into Itens (part,name, img_location, description, price) values (2,'Green eyes', 'https://feupload.fe.up.pt/get/y3CzrvhaC1GRWTz', 'vehicula consequat morbi a ipsum integer a nibh in quis justo maecenas rhoncus aliquam lacus morbi quis', 81);
insert into Itens (part,name, img_location, description, price) values (2,'Brown eyes', 'https://feupload.fe.up.pt/get/7iKlCI8WxFfqjHS', 'metus aenean fermentum donec ut mauris eget massa tempor convallis nulla neque libero convallis eget eleifend', 38);
insert into Itens (part,name, img_location, description, price) values (0,'Brown skin', 'https://feupload.fe.up.pt/get/jMNuBCsnnw6CxTp', 'sit amet cursus id turpis integer aliquet massa id lobortis convallis tortor risus dapibus augue vel accumsan tellus nisi', 53);
insert into Itens (part,name, img_location, description, price) values (0,'Yellow skin', 'https://feupload.fe.up.pt/get/SaiiFQzoz29oQd0', 'turpis elementum ligula vehicula consequat morbi a ipsum integer a nibh in quis justo maecenas rhoncus', 2);
insert into Itens (part,name, img_location, description, price) values (0,'Pink skin', 'https://feupload.fe.up.pt/get/jhh6KCBoGWk8i7i', 'justo aliquam quis turpis eget elit sodales scelerisque mauris sit amet eros', 1);
insert into Itens (part,name, img_location, description, price) values (0,'Blue skin', 'https://feupload.fe.up.pt/get/VJs9kq1eyWGXBQx', 'elit ac nulla sed vel enim sit amet nunc viverra dapibus nulla suscipit ligula in lacus curabitur at', 15);
insert into Itens (part,name, img_location, description, price) values (1,'Blue T-shirt', 'https://feupload.fe.up.pt/get/rY9GKR1J1OBazNp', 'odio curabitur convallis duis consequat dui nec nisi volutpat eleifend donec ut dolor morbi vel lectus in', 94);
insert into Itens (part,name, img_location, description, price) values (1,'White T-shirt', 'https://feupload.fe.up.pt/get/vu5Ju7tE791oBFQ', 'faucibus orci luctus et ultrices posuere cubilia curae duis faucibus accumsan odio', 50);
insert into Itens (part,name, img_location, description, price) values (2,'Black eyes', 'https://feupload.fe.up.pt/get/VKS8mwfba1JOTPy', 'id luctus nec molestie sed justo pellentesque viverra pede ac diam cras pellentesque volutpat dui maecenas tristique', 85);
insert into Itens (part,name, img_location, description, price) values (2,'Red eyes', 'https://feupload.fe.up.pt/get/qr08OmsrYn8KJcA', 'platea dictumst aliquam augue quam sollicitudin vitae consectetuer eget rutrum', 76);
