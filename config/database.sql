...
insert into Itens (part,name, img_location, description, price) values (1,'Blue T-shirt', 'http://i.imgur.com/hMk1Sb8.png', 'odio curabitur convallis duis consequat dui nec nisi volutpat eleifend donec ut dolor morbi vel lectus in', 94);
insert into Itens (part,name, img_location, description, price) values (1,'White T-shirt', 'http://i.imgur.com/38XEYzX.png', 'faucibus orci luctus et ultrices posuere cubilia curae duis faucibus accumsan odio', 50);
insert into Itens (part,name, img_location, description, price) values (2,'Black eyes', 'http://i.imgur.com/sS84mre.png', 'id luctus nec molestie sed justo pellentesque viverra pede ac diam cras pellentesque volutpat dui maecenas tristique', 85);
insert into Itens (part,name, img_location, description, price) values (2,'Red eyes', 'http://i.imgur.com/MKZdj8S.png', 'platea dictumst aliquam augue quam sollicitudin vitae consectetuer eget rutrum', 76);
insert into Itens (part,name, img_location, description, price) values (2,'Green eyes', 'http://i.imgur.com/z8CqW2B.png', 'vehicula consequat morbi a ipsum integer a nibh in quis justo maecenas rhoncus aliquam lacus morbi quis', 81);
insert into Itens (part,name, img_location, description, price) values (2,'Brown eyes', 'http://i.imgur.com/MUM9uNj.png', 'metus aenean fermentum donec ut mauris eget massa tempor convallis nulla neque libero convallis eget eleifend', 38);
insert into Itens (part,name, img_location, description, price) values (0,'Brown skin', 'http://i.imgur.com/Nhsz4TO.png', 'sit amet cursus id turpis integer aliquet massa id lobortis convallis tortor risus dapibus augue vel accumsan tellus nisi', 53);
insert into Itens (part,name, img_location, description, price) values (0,'Yellow skin', 'http://i.imgur.com/XOpyAs4.png', 'turpis elementum ligula vehicula consequat morbi a ipsum integer a nibh in quis justo maecenas rhoncus', 2);
insert into Itens (part,name, img_location, description, price) values (0,'Pink skin', 'http://i.imgur.com/FerKE2m.png', 'justo aliquam quis turpis eget elit sodales scelerisque mauris sit amet eros', 1);
insert into Itens (part,name, img_location, description, price) values (0,'Blue skin', 'http://i.imgur.com/2vWH8O4.png', 'elit ac nulla sed vel enim sit amet nunc viverra dapibus nulla suscipit ligula in lacus curabitur at', 15);
insert into Itens (part,name, img_location, description, price) values (1,'Blue T-shirt', 'http://i.imgur.com/hMk1Sb8.png', 'odio curabitur convallis duis consequat dui nec nisi volutpat eleifend donec ut dolor morbi vel lectus in', 94);
insert into Itens (part,name, img_location, description, price) values (1,'White T-shirt', 'http://i.imgur.com/38XEYzX.png', 'faucibus orci luctus et ultrices posuere cubilia curae duis faucibus accumsan odio', 50);
insert into Itens (part,name, img_location, description, price) values (2,'Black eyes', 'http://i.imgur.com/sS84mre.png', 'id luctus nec molestie sed justo pellentesque viverra pede ac diam cras pellentesque volutpat dui maecenas tristique', 85);
insert into Itens (part,name, img_location, description, price) values (2,'Red eyes', 'http://i.imgur.com/MKZdj8S.png', 'platea dictumst aliquam augue quam sollicitudin vitae consectetuer eget rutrum', 76);
